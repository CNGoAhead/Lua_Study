...
public:
	...
	virtual IMap * Init(int w, int h, std::unordered_map<int, int> hight, std::unordered_map<int, short> flag) = 0;
	virtual IMap * UpdateHeight(const std::unordered_map<int, int> & difh) = 0;
	virtual IMap * UpdateFlag(const std::unordered_map<int, short> & difg) = 0;
	virtual IMap * AddHeight(const std::unordered_map<int, int> & difh) = 0;
	virtual IMap * AddFlag(const std::unordered_map<int, short> & difg) = 0;
	virtual IMap * SubHeight(const std::unordered_map<int, int> & difh) = 0;
	virtual IMap * SubFlag(const std::unordered_map<int, short> & difg) = 0;
